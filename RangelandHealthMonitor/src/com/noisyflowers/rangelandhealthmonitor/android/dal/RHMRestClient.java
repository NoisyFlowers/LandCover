...
public class RHMRestClient {
	...
	private RHMRestClient(Context context) {
		...
		GoogleAccountCredential gAC = GoogleAccountCredential.usingAudience(this.context, "server:client_id:" + RHMApplication.getInstance().getApplicationContext().getString(R.string.lpks_web_client_id)); 		
