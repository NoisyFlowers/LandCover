...
public class RHMDatabaseAdapter {
	...
	private static final String STICK_SEGMENTS_TABLE_CREATE = "create table " + STICK_SEGMENTS_TABLE + " (" +
			...
			RHMApplication.getInstance().getString(R.string.fragment_cover_cover_1).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase() + " integer, " + //boolean
			RHMApplication.getInstance().getString(R.string.fragment_cover_cover_2).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase() + " integer, " + //boolean
			RHMApplication.getInstance().getString(R.string.fragment_cover_cover_3).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase() + " integer, " + //boolean
			RHMApplication.getInstance().getString(R.string.fragment_cover_cover_4).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase() + " integer, " + //boolean
			RHMApplication.getInstance().getString(R.string.fragment_cover_cover_5).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase() + " integer, " + //boolean
			RHMApplication.getInstance().getString(R.string.fragment_cover_cover_6).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase() + " integer, " + //boolean
			RHMApplication.getInstance().getString(R.string.fragment_cover_cover_7).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase() + " integer, " + //boolean
			RHMApplication.getInstance().getString(R.string.fragment_cover_cover_8).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase() + " integer, " + //boolean
			RHMApplication.getInstance().getString(R.string.fragment_cover_cover_9).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase() + " integer" + //boolean
		 ")";
	...
	private Transect loadTransect(Cursor resultSet) {
		Transect retVal = new Transect();
	...
	public Transect getTransect(String siteID, Transect.Direction transectDirection) {
		return getTransect(siteID, transectDirection, false);  //TODO: that false is not used by getTransect.  Is that a problem?
	}
	...
	public List<String> getNonwoodySpeciesList() {
		List<String> speciesList = new ArrayList<String>();
		SQLiteDatabase db = dbHelper.getWritableDatabase();
		try {
			Cursor resultSet = db.query(true, TRANSECTS_TABLE, new String[] {"dominant_nonwoody_species"}, "dominant_nonwoody_species is not null", null, "dominant_nonwoody_species", null, null, null);
			while (resultSet.moveToNext()) {
				speciesList.add(resultSet.getString(0));
			}
			resultSet.close(); //TODO: put in finally?
	...
	public Transect upsertTransect(Transect transect) { 
    	//Log.i(TAG, "upsertSegmentEntry, enter");
		...
		try {
			...
			if (rows == 0) {
				...
				String[] qVals2 = {Long.toString(transect.siteID), transect.direction.name()};
				Cursor resultSet = db.query("transects", new String[] {"_id"}, "site_id = ? and direction = ?", qVals2, null, null, null);
				if (resultSet.moveToNext()) {
	...
	private static class RHMDBHelper extends SQLiteOpenHelper {
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion){
			...
			switch (oldVersion) {
				...
				case 7:
					try {
					    db.execSQL("ALTER TABLE " + TRANSECTS_TABLE + " ADD  COLUMN dominant_woody_species text");
					    db.execSQL("ALTER TABLE " + TRANSECTS_TABLE + " ADD  COLUMN dominant_nonwoody_species text");
					} catch (Exception eX) {
						Log.e(TAG, "Upgrade from db7: Unable to add columns", eX);
						hosed = true;
					}
					try {
						renameColumns(db, SEGMENTS_TABLE_CREATE, SEGMENTS_TABLE, 
								  new String[] {"species_1_count", "species_2_count"}, 
								  new String[] {"woody_species_count", "nonwoody_species_count"});
					} catch (Exception eX) {
						Log.e(TAG, "Upgrade from db7: Unable to rename segments table columns", eX);
						hosed = true;
					}
					try {
						renameColumns(db, STICK_SEGMENTS_TABLE_CREATE, STICK_SEGMENTS_TABLE, 
								  new String[] {
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_1_1_0_1).replaceAll("[^a-zA-Z0-9]", "_"),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_2_1_0_1).replaceAll("[^a-zA-Z0-9]", "_"),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_3_1_0_1).replaceAll("[^a-zA-Z0-9]", "_"),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_4_1_0_1).replaceAll("[^a-zA-Z0-9]", "_"),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_5_1_0_1).replaceAll("[^a-zA-Z0-9]", "_"),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_6_1_0_1).replaceAll("[^a-zA-Z0-9]", "_"),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_7_1_0_1).replaceAll("[^a-zA-Z0-9]", "_"),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_8_1_0_1).replaceAll("[^a-zA-Z0-9]", "_"),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_9_1_0_1).replaceAll("[^a-zA-Z0-9]", "_")
								  }, 
								  new String[] {
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_1).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase(),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_2).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase(),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_3).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase(),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_4).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase(),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_5).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase(),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_6).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase(),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_7).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase(),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_8).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase(),
									RHMApplication.getInstance().getString(R.string.fragment_cover_cover_9).replaceAll("[^a-zA-Z0-9]", "_").toLowerCase()
								  });
